...
<div class="container">
    <ul>
    <li class="a" style="background-color: #4C5AFF"><a href="#">All</a></li>
...
if(empty($rowi)){
  ...
  $grade->bindParam(1,$rowi['id']);
  $grade->execute();
  $row2= $grade->fetch();
  if(empty($row2)){
    echo"<p style='color:#640000;'><b>Not Graded</b></p>";
  }
  else{
...
<section id="d1">
  ...
  $stmt->execute();
  echo "<p class='section_heading'>Your History: </p><hr><br><br>";
...
echo "<a href='scripts/clear_sui.php?id=".$uem."' class='upl' style='margin-left:500px;'>Clear History</a>"
  ?>
</section>
</div>
</div>
